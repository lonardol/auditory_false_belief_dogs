...
#load("power_sim_Auditory_FB_VIII.RData") 
```
...
age.range=c(10:168) 
breed = c("fci1","fci2","fci5","fci6","fci7", "fci8", "fci10") # edited by LL, includes both cooperative and independent breed groups. In Lonardo et al. (2021), Exp. 1, cooperative breeds were more represented in the sample.
...
r.slope.condition <- 1.1  #abs(qlogis(fb.per))-abs(qlogis(know.per))
# r.slope.sex <- 0.4 
...
save.image("power_sim_Auditory_FB_VIII.RData")
```
