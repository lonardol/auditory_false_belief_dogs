...
#load("power_sim_Auditory_FB.RData_III") not yet saved
```
...
r.slope.condition <- 0.9  #abs(qlogis(fb.per))-abs(qlogis(know.per))
# r.slope.sex <- 0.4 
...
save.image("power_sim_Auditory_FB.RData_III")
```
