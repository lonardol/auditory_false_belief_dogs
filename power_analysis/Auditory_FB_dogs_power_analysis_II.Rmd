...
#load("power_sim_Auditory_FB.RData_II") not yet saved
```
...
n.subject <- seq(from=120, to=240, by=12)# number subjects (from 40 to 80 per condition). Edited by LL
...
save.image("power_sim_Auditory_FB.RData_II")
```
